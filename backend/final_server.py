#!/usr/bin/env python3
"""
Final working server for authentication
"""
...
app = FastAPI(title="RichesReach Final Server")
...
@app.get("/")
async def root():
    return {"message": "RichesReach Final Server is running"}
...
async def graphql_endpoint(request: Request):
    ...
    try:
        ...
        if "stocks" in query and "query" in query:
            return {
                "data": {
                    "stocks": [
                        {
        ...
        elif "beginnerFriendlyStocks" in query and "query" in query:
            return {
                "data": {
        ...
        elif "myWatchlist" in query and "query" in query:
            return {
                "data": {
                    "myWatchlist": [
                        {
