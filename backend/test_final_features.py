#!/usr/bin/env python3
"""
Final comprehensive test using correct GraphQL schema fields
"""
import os
import sys
import django
...
def test_stock_queries():
    ...
    try:
        # Test stocks query with correct fields from StockType
        stocks_data = {
            'query': '''
                query {
                    stocks {
...
def test_watchlist_queries():
    ...
    try:
        # Test watchlists query with correct fields from WatchlistType
        watchlist_data = {
            'query': '''
                query {
                    watchlists {
...
def test_social_features():
    ...
    try:
        # Test allPosts query with correct fields from PostType
        posts_data = {
            'query': '''
                query {
                    allPosts {
...
def test_chat_features():
    ...
    try:
        # Test myChatSessions query with correct fields from ChatSessionType
        chat_data = {
            'query': '''
                query {
                    myChatSessions {
...
def main():
    """Run all tests"""
    print("🚀 Starting final comprehensive feature tests...")
    print("=" * 60)
