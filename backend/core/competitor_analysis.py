...
class CompetitorAnalyzer:
    ...
    async def generate_recommendations(self, results: Dict[str, Any]) -> List[str]:
        ...
        if our_performance.avg_confidence > 75:
            ...
            recommendations.append("⚠️ Moderate confidence scores - consider model improvements")
        else:
        ...
        if our_performance.win_rate > 0.6:
            ...
            recommendations.append("⚠️ Moderate win rate - monitor performance closely")
        else:
        ...
        if our_performance.personalization_score > 8:
            ...
            recommendations.append("⚠️ Good personalization - continue improving")
        else:
