...
# Test 1: Health Check
self.stdout.write("\n1⃣ Testing Rust Service Health...")
try:
...
self.stdout.write("\n2⃣ Testing Service Availability...")
...
self.stdout.write("\n5⃣ Testing Django Service Integration...")
try:
...
self.stdout.write(self.style.WARNING(" Django-Rust Integration returned no data"))
except Exception as e:
