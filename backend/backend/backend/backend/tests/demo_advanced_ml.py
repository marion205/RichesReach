...
print(" Deep learning not available. Install TensorFlow for full functionality.")
...
print(f" Deep Learning: {' Available' if dl_service.is_available() else ' Limited'}")
print(f" ML Service: {' Available' if ml_service.is_available() else ' Limited'}")
...
print(" Deep learning not available for integration")
