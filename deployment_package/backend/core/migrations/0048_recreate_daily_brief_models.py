# Recreate daily brief tables removed in 0042 so daily_brief_api and daily_brief_models work.
# Use when migration state says 0040/0042 applied but tables were never created or were dropped.
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('completed_lesson_ids', models.JSONField(default=list, help_text='List of lesson IDs the user has completed (prevents double-counting)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='brief_completions', to=settings.AUTH_USER_MODEL)),
            ],
            options={
