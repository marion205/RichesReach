...
try:
    from .wealth_arrival_types import WealthArrivalQueries
except (ImportError, SyntaxError) as e:
    logger.warning(f"WealthArrivalQueries not available: {e}")
    class WealthArrivalQueries(graphene.ObjectType):
        pass

try:
    from .subscription_detector_types import LeakDetectorQueries
except (ImportError, SyntaxError) as e:
    logger.warning(f"LeakDetectorQueries not available: {e}")
    class LeakDetectorQueries(graphene.ObjectType):
        pass

try:
    from .net_worth_types import NetWorthQueries
except (ImportError, SyntaxError) as e:
    logger.warning(f"NetWorthQueries not available: {e}")
    class NetWorthQueries(graphene.ObjectType):
        pass

try:
    from .financial_health_types import FinancialHealthQueries
except (ImportError, SyntaxError) as e:
    logger.warning(f"FinancialHealthQueries not available: {e}")
    class FinancialHealthQueries(graphene.ObjectType):
        pass

try:
    from .life_decision_types import LifeDecisionQueries
except (ImportError, SyntaxError) as e:
    logger.warning(f"LifeDecisionQueries not available: {e}")
    class LifeDecisionQueries(graphene.ObjectType):
        pass

try:
    from .income_intelligence_types import IncomeIntelligenceQueries
except (ImportError, SyntaxError) as e:
    logger.warning(f"IncomeIntelligenceQueries not available: {e}")
