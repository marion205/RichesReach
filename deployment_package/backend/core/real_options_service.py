...
class RealOptionsService:
    ...
    def _generate_realistic_options_from_price(self, symbol: str, current_price: float) -> Dict[str, Any]:
        ...
        for i, exp_date in enumerate(expiration_dates):
            ...
            for strike_offset in strike_range:
                ...
                time_value_base = current_price * 0.02 * (days_to_exp / 365)
                time_value_multiplier = 1.0 - (i * 0.2)  # Less time value for longer expiration
                ...
                calls.append({
                    ...
                    'implied_volatility': round(0.25 + random.uniform(-0.1, 0.1), 3),
                    ...
                    'intrinsic_value': intrinsic_value_call,
                ...
                puts.append({
                    ...
                    'intrinsic_value': intrinsic_value_put,
                    'time_value': time_value,
                    'days_to_expiration': days_to_exp
                })
        ...
        return {
            ...
            'recommended_strategies': self._generate_recommended_strategies(symbol, current_price),
            'market_sentiment': self._generate_stock_specific_sentiment(symbol, current_price)
        }

    def _generate_unusual_flow(self, symbol: str, current_price: float) -> List[Dict[str, Any]]:
        ...
        for i in range(3):  # Generate 3 unusual flows
            ...
            unusual_flows.append({
                'symbol': symbol,
                'contract_symbol': f"{symbol}240101{option_type[0].upper()}{strike:08.0f}",
                ...
                'implied_volatility': round(0.25 + random.uniform(-0.1, 0.1), 3),
                'unusual_activity_score': round(random.uniform(0.7, 0.95), 2),
                'activity_type': random.choice(['Large Block Trade', 'Sweep', 'Unusual Volume'])
            })
        
        return unusual_flows
    
    def _generate_recommended_strategies(self, symbol: str, current_price: float) -> List[Dict[str, Any]]:
        ...
        strategies = [
            ...
            },
            {
                ...
                'breakeven_points': [current_price - 8, current_price + 8],
                ...
                'risk_level': 'Medium',
                'description': 'Sell both call and put spreads for range-bound markets',
            ...
            },
            {
                ...
                'max_loss': round(current_price * 0.05, 2),
                'breakeven_points': [current_price + 3.0],
    ...
    def _generate_stock_specific_sentiment(self, symbol: str, current_price: float) -> Dict[str, Any]:
        ...
        sentiment_score = max(20, min(80, base_sentiment))
        ...
        skew = (sentiment_score - 50) / 100 * 0.3  # -0.15 to +0.15
    ...
    def _calculate_realistic_greeks(self, symbol: str, current_price: float) -> Dict[str, float]:
        ...
        # Adjust Greeks based on price level
        price_factor = current_price / 150.0  # Normalize to $150 baseline
        ...
        market_volatility = 0.8 + 0.4 * time_factor  # Simulate changing market volatility
