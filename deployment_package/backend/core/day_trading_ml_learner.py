...
class DayTradingMLearner:
    ...
    def extract_features_from_signal(self, signal) -> Dict:
        ...
        """
        raw_features = signal.features if isinstance(signal.features, dict) else {}
        features_dict = raw_features.get('_full_features', raw_features)
        ...
        return {
            'momentum_15m': float(features_dict.get('momentum15m', features_dict.get('momentum_15m', 0.0))),
            'rvol_10m': float(features_dict.get('rvol10m', features_dict.get('volume_ratio', 1.0))),
            'vwap_dist': float(features_dict.get('vwapDist', features_dict.get('vwap_dist', 0.0))),
            'spread_bps': spread_bps,  # Execution feature
            'execution_quality_score': execution_quality,  # Execution feature
            'breakout_pct': float(features_dict.get('breakoutPct', features_dict.get('breakout_pct', 0.0))),
            'catalyst_score': float(features_dict.get('catalystScore', features_dict.get('catalyst_score', 0.0))),
            'volume_ratio': float(features_dict.get('volumeRatio', features_dict.get('volume_ratio', 1.0))),
            'volume_zscore': float(features_dict.get('volumeZscore', features_dict.get('volume_zscore', 0.0))),
            'rsi_14': float(features_dict.get('rsi14', features_dict.get('rsi_14', 50.0))),
            'is_trend_regime': float(features_dict.get('isTrendRegime', features_dict.get('is_trend_regime', 0.0))),
            'is_range_regime': float(features_dict.get('isRangeRegime', features_dict.get('is_range_regime', 0.0))),
            'is_high_vol_chop': float(features_dict.get('isHighVolChop', features_dict.get('is_high_vol_chop', 0.0))),
            'regime_confidence': float(features_dict.get('regimeConfidence', features_dict.get('regime_confidence', 0.5))),
            'is_vol_expansion': float(features_dict.get('isVolExpansion', features_dict.get('is_vol_expansion', 0.0))),
            'is_breakout': float(features_dict.get('isBreakout', features_dict.get('is_breakout', 0.0))),
            'is_three_white_soldiers': float(features_dict.get('isThreeWhiteSoldiers', features_dict.get('is_three_white_soldiers', 0.0))),
            'is_engulfing_bull': float(features_dict.get('isEngulfingBull', features_dict.get('is_engulfing_bull', 0.0))),
            'is_engulfing_bear': float(features_dict.get('isEngulfingBear', features_dict.get('is_engulfing_bear', 0.0))),
            'is_hammer': float(features_dict.get('isHammer', features_dict.get('is_hammer', 0.0))),
            'is_doji': float(features_dict.get('isDoji', features_dict.get('is_doji', 0.0))),
            'vwap_dist_pct': float(features_dict.get('vwapDistPct', features_dict.get('vwap_dist_pct', 0.0))),
            'macd_hist': float(features_dict.get('macdHist', features_dict.get('macd_hist', 0.0))),
            'bb_position': float(features_dict.get('bbPosition', features_dict.get('bb_position', 0.5))),
            'trend_strength': float(features_dict.get('trendStrength', features_dict.get('trend_strength', 0.0))),
            'price_above_sma20': float(features_dict.get('priceAboveSma20', features_dict.get('price_above_sma20', 0.0))),
            'price_above_sma50': float(features_dict.get('priceAboveSma50', features_dict.get('price_above_sma50', 0.0))),
            'sma20_above_sma50': float(features_dict.get('sma20AboveSma50', features_dict.get('sma20_above_sma50', 0.0))),
            'is_opening_hour': float(features_dict.get('isOpeningHour', features_dict.get('is_opening_hour', 0.0))),
            'is_closing_hour': float(features_dict.get('isClosingHour', features_dict.get('is_closing_hour', 0.0))),
            'is_midday': float(features_dict.get('isMidday', features_dict.get('is_midday', 0.0))),
            'sentiment_score': float(features_dict.get('sentimentScore', features_dict.get('sentiment_score', 0.0))),
            'sentiment_volume': float(features_dict.get('sentimentVolume', features_dict.get('sentiment_volume', 0.0))),
            'sentiment_divergence': float(features_dict.get('sentimentDivergence', features_dict.get('sentiment_divergence', 0.0))),
