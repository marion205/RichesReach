...
export const PRODUCTION_API_BASE_URL = process.env.EXPO_PUBLIC_API_URL || 'http://54.162.138.209:8000';
export const PRODUCTION_GRAPHQL_URL = process.env.EXPO_PUBLIC_GRAPHQL_URL || 'http://54.162.138.209:8000/graphql/';
export const PRODUCTION_WS_URL = process.env.EXPO_PUBLIC_WS_URL || 'ws://54.162.138.209:8000/ws';
