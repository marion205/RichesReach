  ...
  sellRecommendations: [
    {
      ...
      currentPrice: 196.50,
      rationale: 'Margin compression from price wars; competition intensifying',
      confidence: 0.71,
      __typename: 'StockRecommendation',
    },
  ],
  riskAssessment: 'Your portfolio beta is 1.15 — slightly above market. Consider adding a low-beta position (utilities or consumer staples) for balance.',
  marketOutlook: 'Constructive. Fed pivot expectations support equity valuations. Watch for Q2 earnings revisions.',
