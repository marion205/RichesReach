...
print("⏱ Training models (happens every time)...")
...
print(f" ⏱ Initial Training Time: {training_time:.1f}s")
...
print("="*60)
print(f"⏱ Original Service Time: {original_time:.1f} seconds")
...
print(f"\n⏱ Total time for {len(test_cases)} predictions: {total_time*1000:.1f}ms")
